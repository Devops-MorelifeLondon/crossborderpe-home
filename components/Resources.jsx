...
import { blogPosts, categories, tags, BlogPost } from '../data/blogData';
            ...
            <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {featuredPosts.map((post) => (
                  <Link key={post.id} to={`/resources/blog/${post.id}`} className="group">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-8 lg:space-y-0 lg:space-x-8">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-16 pr-6 py-5 border border-slate-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-lg"
                  />
                </div>
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <select
                    ...
                    className="px-6 py-5 border border-slate-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-lg"
                  >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-2xl text-slate-600 max-w-5xl mx-auto leading-relaxed font-light">
            Access cutting-edge research, expert analysis, and comprehensive resources to optimize 
            your international payment operations and drive global business growth.
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2">
            {resourceTabs.map((tab) => (
              <button
                ...
                className={`flex flex-col items-center space-y-2 px-4 py-6 rounded-2xl font-semibold transition-all text-center ${
                  activeTab === tab.id
